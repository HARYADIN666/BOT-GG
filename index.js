...
const wa = 'https://whatsapp.com'; // LINK GRUP WA JANGAN DIGANTI YA BIAR KUMPUL DISITU SALING MENGENAL:)
const ow = 'HARYADIN'; // GANTI PAKE NAMA MU
...
const vcard = 'BEGIN:VCARD\n'
  ...
  + 'TEL;type=CELL;type=VOICE;waid=6282279601471':+62 822-7960-1471-1471\n' // GANTI PAKE NOMOR LU ( SAMAIN KEK GITU YA )
...
conn.sendMessage(id, '*Lu Asw*' ,MessageType.text);
 ...
 if (text == 'iya'){
conn.sendMessage(id, '*Ah masa..... sih...*' ,MessageType.text);
}
if (text == 'konsol'){
conn.sendMessage(id, '*Astagfirullah....tobat ngab-_*' ,MessageType.text);
}
if (text == 'konsol'){
conn.sendMessage(id, '*Astagfirullah....tobat ngab-_*' ,MessageType.text);
}
if (text == 'Njir'){
conn.sendMessage(id, '*Punya mulut dijaga sayang...*' ,MessageType.text);
}
if (text == 'njir'){
conn.sendMessage(id, '*Punya mulut dijaga sayang...*' ,MessageType.text);
}
if (text == 'Bot goblok'){
conn.sendMessage(id, '*Wih ada bang jago:b*' ,MessageType.text);
}
if (text == 'Konsol'){
conn.sendMessage(id, '*Astagfirullah....tobat ngab-_*' ,MessageType.text);
}
...
conn.sendMessage(id, '*lu bacot_-*' ,MessageType.text);
 ...
 if (text == 'Felix'){
conn.sendMessage(id, '*Admin ganteng*' ,MessageType.text);
}
 if (text == 'Hai'){
...
conn.sendMessage(id, '*Hi juga, Ada yang bisa saya bantu? kalo bingung ketik !menu ya kak🤗...*' ,MessageType.text);
 ...
 if (text == 'haryadin'){
conn.sendMessage(id, '*Dia owner ku*' ,MessageType.text);
}
 if (text == 'Haryadin'){
conn.sendMessage(id, '*Dia owner ku*' ,MessageType.text);
}
